		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Relatório EDU",
									"targetURL": "#comcoopersaprelatorioedu-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcoopersaprelatorioedu-display": {
								"semanticObject": "comcoopersaprelatorioedu",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.coopersap.relatorioedu",
									"url": sap.ui.require.toUrl("com/coopersap/relatorioedu")
								}
							}
						}
					}
